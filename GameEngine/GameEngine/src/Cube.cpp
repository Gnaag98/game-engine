...
Cube::Cube(const bool psychedelic) {
  ...
  triangles.emplace_back(1, 2, 3, verticies, 4, 4, 4, normals);
  triangles.emplace_back(3, 0, 1, verticies, 4, 4, 4, normals);
  triangles.emplace_back(6, 5, 4, verticies, 5, 5, 5, normals);
  triangles.emplace_back(4, 7, 6, verticies, 5, 5, 5, normals);
  triangles.emplace_back(4, 5, 1, verticies, 1, 1, 1, normals);
  triangles.emplace_back(1, 0, 4, verticies, 1, 1, 1, normals);
  triangles.emplace_back(3, 2, 6, verticies, 0, 0, 0, normals);
  triangles.emplace_back(6, 7, 3, verticies, 0, 0, 0, normals);
  triangles.emplace_back(4, 0, 3, verticies, 2, 2, 2, normals);
  triangles.emplace_back(3, 7, 4, verticies, 2, 2, 2, normals);
  triangles.emplace_back(1, 5, 6, verticies, 3, 3, 3, normals);
  triangles.emplace_back(6, 2, 1, verticies, 3, 3, 3, normals);
}
